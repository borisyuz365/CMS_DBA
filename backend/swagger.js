    ...
    components: {
      parameters: {
        ...
        BpQueryPublisher: {
          ...
          required: false,
          schema: { type: 'string' },
          description: 'Attribution network name (T_PUBLISHERS.ALIAS_NAME — same value as the mobile API `publisher` param). Omit to match any network.',
      ...
      schemas: {
          ...
          properties: {
            ...
            Targeting: {
              ...
              properties: {
                ...
                Publisher: { type: 'string', nullable: true, description: 'Attribution network name — null matches any network.' },
        ...
        Promotion: {
          ...
          properties: {
            ...
            lang:     { type: 'integer', nullable: true, description: 'Language ID — null matches any language' },
            publisher:{ type: 'string', nullable: true, description: 'Attribution network name (T_PUBLISHERS.ALIAS_NAME) — null matches any network' },
            campaign: { type: 'string', nullable: true, description: 'Campaign name — null matches any campaign' },
